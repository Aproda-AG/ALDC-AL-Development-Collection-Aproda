...
This agent draws on these skills from `.agents/skills/aldc/references/skills/`. They are **not** auto-loaded — **load the `GUIDE.md` on demand** (the available file reading/search tool it) when the task enters that domain:
