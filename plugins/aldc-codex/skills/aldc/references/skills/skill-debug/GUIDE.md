...
3. Use al-symbols-mcp `al_find_references` (or Search for text search) to find all assignments
...
1. Narrow down scope with Search/Search and al-symbols-mcp `al_find_references`
