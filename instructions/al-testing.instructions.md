...
3. **Test app folders**: `[Test]` codeunits go in `Test/TestCases/`; reusable helper/library codeunits in `Test/TestLibrary/`. A helper used by 2+ test codeunits belongs in `TestLibrary`, not copied per case.
