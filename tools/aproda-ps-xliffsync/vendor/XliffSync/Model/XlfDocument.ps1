        ...
        switch ($this.Version()) {
            "1.2" {
                switch ($translationState) {
                    ...
                    ([XlfTranslationState]::NeedsReviewTranslation) {
                        $stateNode.SetAttribute('state', 'needs-review-translation');
                        break;
                    }
                    ([XlfTranslationState]::NeedsLocalization) {
                        $stateNode.SetAttribute('state', 'needs-l10n');
                        break;
                    }
                    ...
                    if ($stateValue) {
                        switch ($stateValue) {
                            ...
                            'needs-review-translation' {
                                return [XlfTranslationState]::NeedsReviewTranslation;
                            }
                            'needs-l10n' {
                                return [XlfTranslationState]::NeedsLocalization;
                            }
                            'translated' {
