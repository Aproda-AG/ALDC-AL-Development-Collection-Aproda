...
tools: [vscode, execute, read, agent, edit, search, web, github/search_code, github/search_repositories, github/search_code, github/search_repositories, github/search_code, github/search_repositories, 'markitdown/*', 'microsoft-learn/*', 'context7/*', vscode.mermaid-chat-features/renderMermaidDiagram, ms-vscode.vscode-websearchforcopilot/websearch, todo]
