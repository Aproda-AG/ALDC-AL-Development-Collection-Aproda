---
description: |
  Generate AL code for Business Central Agent SDK task integration. Applies patterns from skill-agent-task-patterns to generate production-ready codeunits, page extensions, and event subscribers. Use when implementing agent task integrations.
---
